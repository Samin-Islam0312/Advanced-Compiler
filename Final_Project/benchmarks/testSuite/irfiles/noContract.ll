; ModuleID = 'testSuite/testFiles/noContract.c'
source_filename = "testSuite/testFiles/noContract.c"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx26.0.0"

; Function Attrs: mustprogress nofree norecurse nosync nounwind ssp willreturn memory(none) uwtable(sync)
define noundef float @strict_fp(float noundef %0, float noundef %1, float noundef %2) local_unnamed_addr #0 {
  %4 = fmul float %0, %1
  %5 = fadd float %4, %2
  ret float %5
}
